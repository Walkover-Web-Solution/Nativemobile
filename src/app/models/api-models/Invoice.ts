...
export class Esignature {
    ...
    public SelectPage = 'LAST';
    public ReferenceNumber = '';
    public AadhaarNumber = '';
    public SignatureType = '1';
    public SignaturePosition = 'Customize';
    public authToken = 'YkvC7sGkgLDNT67ZvxCXg7t2Cy0FjUI8QTSh44QWo+Y=';
    public PageNumber = '';
    public FileType = 'PDF';
    public PreviewRequired = true;
    public CustomizeCoordinates = '420,200,540,150';
    public PagelevelCoordinates = '';
    public UploadSignatureOption = true;
    public SelectFontOption = true;
    public DrawSignatureOption = true;
    public eSignaturePadOption = true;
    public SUrl = 'https://esign.giddh.com/Fu59xHxuPsQFWEy4zhwB/';
    public FUrl = 'https://esign.giddh.com/fxaLuXqhG9GhvCezvqMp/';
    public CUrl = 'https://esign.giddh.com/fxaLuXqhG9GhvCezvqMp/';
}
