...
export interface LoginState {
    ...
    isSignupWithLinkedInInProcess: boolean;
    isSignupWithLinkedInSuccess: boolean;
    ...
    switch (action.type) {
        ...
        case LoginConstants.SIGNUP_WITH_GOOGLE_RESPONSE: {
            ...
            if (data.status === 'success') {
                return Object.assign({}, state, {
                    ...
                    isLoggedInWithSocialAccount: true
                })
            }
            return Object.assign({}, state, {
                isSignupWithGoogleInProcess: false,
        ...
        case LoginConstants.SIGNUP_WITH_LINKEDIN_RESPONSE: {
            ...
            if (res.status === 'success') {
                return Object.assign({}, state, {
                    isSignupWithLinkedInInProcess: false,
                    isSignupWithLinkedInSuccess: true,
                    isLoggedInWithSocialAccount: true
                })
            }
            return Object.assign({}, state, {
        ...
        case LoginConstants.RESET_LOGIN_STATE:
            return initialState;
        case LoginConstants.SOCIAL_LOGOUT_ATTEMPT: {
            return Object.assign({}, state, {
                isSocialLogoutAttempted: true
            });
        }
        case LoginConstants.RESET_SOCIAL_LOGOUT_ATTEMPT: {
            return Object.assign({}, state, {
                isSocialLogoutAttempted: false
            });
        }
