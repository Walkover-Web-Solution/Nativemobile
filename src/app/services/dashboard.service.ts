...
export class DashboardService {
    ...
    public Dashboard(fromDate: string = '', toDate: string = '', interval: string = 'monthly', refresh: boolean = false): Observable<BaseResponse<DashboardResponse, string>> {
        ...
        return this._http.get(this.config.apiUrl + DASHBOARD_API.DASHBOARD.replace(':companyUniqueName', encodeURIComponent(this.companyUniqueName)).replace(':from', encodeURIComponent(fromDate)).replace(':to', encodeURIComponent(toDate)).replace(':interval', interval).replace(':refresh', refresh.toString())).pipe(map((res) => {
            const data: BaseResponse<DashboardResponse, string> = res;
    ...
    public GetGroupHistory(model: GroupHistoryRequest, fromDate: string = '', toDate: string = '', interval: string = 'monthly', refresh: boolean = false): Observable<BaseResponse<GroupHistoryResponse, GroupHistoryRequest>> {
        ...
        return this._http.post(this.config.apiUrl + DASHBOARD_API.GROUP_HISTORY.replace(':companyUniqueName', encodeURIComponent(this.companyUniqueName)).replace(':from', encodeURIComponent(fromDate)).replace(':to', encodeURIComponent(toDate)).replace(':interval', interval).replace(':refresh', refresh.toString()), model).pipe(map((res) => {
            const data: BaseResponse<GroupHistoryResponse, GroupHistoryRequest> = res;
            data.request = model;
            data.queryString = {fromDate, toDate, interval, refresh};
            return data;
    ...
    public GetClosingBalance(groupUniqueName: string = '', fromDate: string = '', toDate: string = '', refresh: boolean = false): Observable<BaseResponse<ClosingBalanceResponse, string>> {
        ...
        return this._http.get(this.config.apiUrl + DASHBOARD_API.CLOSING_BALANCE.replace(':companyUniqueName', encodeURIComponent(this.companyUniqueName)).replace(':fromDate', fromDate).replace(':toDate', toDate).replace(':groupUniqueName', encodeURIComponent(groupUniqueName)).replace(':refresh', refresh.toString())).pipe(map((res) => {
            const data: BaseResponse<ClosingBalanceResponse, string> = res;
            data.queryString = {fromDate, toDate, groupUniqueName, refresh};
            data.request = '';
            return data;
        }), catchError((e) => this.errorHandler.HandleCatch<ClosingBalanceResponse, string>(e, '', {
            fromDate,
            toDate,
            groupUniqueName,
            refresh
    ...
    public GetClosingBalanceV2(groups: string[], fromDate: string = '', toDate: string = '', refresh: boolean = false): Observable<BaseResponse<ClosingBalanceResponse[], string[]>> {
        ...
        return this._http.post(this.config.apiUrl + DASHBOARD_API.CLOSING_BALANCE_V2
            ...
            .replace(':refresh', refresh.toString()), {groups}).pipe(map((res) => {
            const data: BaseResponse<ClosingBalanceResponse[], string[]> = res;
            data.queryString = {fromDate, toDate, refresh};
            data.request = groups;
            return data;
        }), catchError((e) => this.errorHandler.HandleCatch<ClosingBalanceResponse[], string[]>(e, groups, {
            fromDate,
            toDate,
            refresh
        })));
    ...
    public GetBankAccounts(): Observable<BaseResponse<BankAccountsResponse[], string>> {
        ...
        return this._http.get(this.config.apiUrl + DASHBOARD_API.BANK_ACCOUNTS.replace(':companyUniqueName', encodeURIComponent(this.companyUniqueName))).pipe(map((res) => {
            const data: BaseResponse<BankAccountsResponse[], string> = res;
            data.request = '';
            return data;
    ...
    public RefreshBankAccount(loginId: string): Observable<BaseResponse<RefreshBankAccountResponse, string>> {
        ...
        return this._http.get(this.config.apiUrl + DASHBOARD_API.REFRESH_BANK_ACCOUNT.replace(':companyUniqueName', encodeURIComponent(this.companyUniqueName)).replace(':loginId', loginId)).pipe(map((res) => {
            const data: BaseResponse<RefreshBankAccountResponse, string> = res;
            data.request = '';
            return data;
    ...
    public GetCategoryHistory(model: GroupHistoryRequest, fromDate: string = '', toDate: string = '', interval: string = 'monthly', refresh: boolean = false) {
        this.user = this._generalService.user;
        this.companyUniqueName = this._generalService.companyUniqueName;
        return this._http.post(this.config.apiUrl + DASHBOARD_API.CATEGORY_HISTORY.replace(':companyUniqueName', encodeURIComponent(this.companyUniqueName)).replace(':from', encodeURIComponent(fromDate)).replace(':to', encodeURIComponent(toDate)).replace(':interval', interval), model).pipe(map((res) => {
            const data: BaseResponse<CategoryHistoryResponse[], GroupHistoryRequest> = res;
            data.request = model;
            data.queryString = {fromDate, toDate, interval, refresh};
            return data;
        }), catchError((e) => this.errorHandler.HandleCatch<CategoryHistoryResponse[], GroupHistoryRequest>(e, model, {
            fromDate,
            toDate,
            interval,
            refresh
    ...
    public GetHistory(model: GroupHistoryRequest, fromDate: string = '', toDate: string = '', interval: string = 'monthly', refresh: boolean = false) {
        this.user = this._generalService.user;
        this.companyUniqueName = this._generalService.companyUniqueName;
        return this._http.post(this.config.apiUrl + DASHBOARD_API.HISTORY.replace(':companyUniqueName', encodeURIComponent(this.companyUniqueName)).replace(':from', encodeURIComponent(fromDate)).replace(':to', encodeURIComponent(toDate)).replace(':interval', interval), model).pipe(map((res) => {
            const data: BaseResponse<GroupHistoryResponse, GroupHistoryRequest> = res;
            data.request = model;
            data.queryString = {fromDate, toDate, interval, refresh};
            return data;
