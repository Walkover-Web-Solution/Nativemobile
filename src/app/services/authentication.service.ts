...
export class AuthenticationService {
    ...
    public VerifyEmail(model: VerifyEmailModel): Observable<BaseResponse<VerifyEmailResponseModel, VerifyEmailModel>> {
        return this._http.post(this.config.apiUrl + LOGIN_API.VerifyEmail, model).pipe(map((res) => {
            const data: BaseResponse<VerifyEmailResponseModel, VerifyEmailModel> = res;
            data.request = model;
            // console.log(data);
            return data;
    ...
    public ForgotPassword(email: string): Observable<BaseResponse<string, string>> {
        return this._http.put(this.config.apiUrl +
            LOGIN_API.ForgotPassword.replace(':email', email), '').pipe(map((res) => {
            const data: BaseResponse<string, string> = res;
            // data.request = modele;
            return data;
    ...
    public ResetPasswordV2(request: ResetPasswordV2): Observable<BaseResponse<string, ResetPasswordV2>> {
        return this._http.put(this.config.apiUrl +
            LOGIN_API.ResetPasswordV2, request).pipe(map((res) => {
            const data: BaseResponse<string, ResetPasswordV2> = res;
            data.request = request;
            return data;
        }), catchError((e) => this.errorHandler.HandleCatch<string, ResetPasswordV2>(e)));
    }
    ...
    public SignupWithMobile(model: SignupWithMobile): Observable<BaseResponse<string, SignupWithMobile>> {
        ...
        return this._http.post(this.config.apiUrl + LOGIN_API.SignupWithMobile, model).pipe(map((res) => {
            const data: BaseResponse<string, SignupWithMobile> = res;
            data.request = model;
            return data;
    ...
    public VerifyOTP(modele: VerifyMobileModel): Observable<BaseResponse<VerifyMobileResponseModel, VerifyMobileModel>> {
        return this._http.post(this.config.apiUrl + LOGIN_API.VerifyOTP, modele).pipe(map((res) => {
            const data: BaseResponse<VerifyMobileResponseModel, VerifyMobileModel> = res;
            data.request = modele;
            // console.log(data);
            return data;
    ...
    public SignupWithPassword(modele: SignUpWithPassword): Observable<BaseResponse<VerifyMobileResponseModel, SignUpWithPassword>> {
        return this._http.post(this.config.apiUrl + LOGIN_API.SignupWithPassword, modele).pipe(map((res) => {
            const data: BaseResponse<VerifyMobileResponseModel, SignUpWithPassword> = res;
            data.request = modele;
            // console.log(data);
            return data;
    ...
    public LoginWithPassword(modele: LoginWithPassword): Observable<BaseResponse<VerifyMobileResponseModel, LoginWithPassword>> {
        return this._http.post(this.config.apiUrl + LOGIN_API.LoginWithPassword, modele).pipe(map((res) => {
            const data: BaseResponse<VerifyMobileResponseModel, LoginWithPassword> = res;
            data.request = modele;
            // console.log(data);
            return data;
    ...
    public VerifyNumberOTP(modele: VerifyMobileModel): Observable<BaseResponse<string, VerifyMobileModel>> {
        return this._http.put(this.config.apiUrl + LOGIN_API.VerifyNumber, modele).pipe(map((res) => {
            const data: BaseResponse<string, VerifyMobileModel> = res;
            data.request = modele;
            return data;
    ...
    public ClearSession(): Observable<BaseResponse<string, string>> {
        const userName = this._generalService.user.uniqueName;
    ...
    public LoginWithGoogle(token: string) {
        ...
        return this._Http.get(this.config.apiUrl + LOGIN_API.LOGIN_WITH_GOOGLE, {
            ...
            const data: BaseResponse<VerifyEmailResponseModel, string> = res as BaseResponse<VerifyEmailResponseModel, string>;
            return data;
    ...
    public LoginWithLinkedin(model: LinkedInRequestModel) {
        ...
        return this._Http.get(this.config.apiUrl + LOGIN_API.LOGIN_WITH_LINKEDIN, {
            ...
            const data: BaseResponse<VerifyEmailResponseModel, LinkedInRequestModel> = res as BaseResponse<VerifyEmailResponseModel, LinkedInRequestModel>;
            data.request = model;
            return data;
    ...
    public SetSettings(model): Observable<BaseResponse<string, string>> {
        const uniqueName = this._generalService.user.uniqueName;
    ...
    public GetSubScribedCompanies(): Observable<BaseResponse<string, string>> {
        const userUniqueName = this._generalService.user.uniqueName;
    ...
    public GetAuthKey(): Observable<BaseResponse<AuthKeyResponse, string>> {
        ...
        return this._http.get(this.config.apiUrl + LOGIN_API.GET_AUTH_KEY
            .replace(':uniqueName', uniqueName)).pipe(map((res) => {
            const data: BaseResponse<AuthKeyResponse, string> = res;
            data.request = '';
            data.queryString = {};
            // data.response.results.forEach(p => p.isOpen = false);
            return data;
    ...
    public RegenerateAuthKey(): Observable<BaseResponse<AuthKeyResponse, string>> {
        const userEmail = this._generalService.user.email;
    ...
    public GetAtuhToken(token: any) {
        ...
        args.headers = new HttpHeaders(args.headers);
        const creds = 'client_id=641015054140-3cl9c3kh18vctdjlrt9c8v0vs85dorv2.apps.googleusercontent.com'
