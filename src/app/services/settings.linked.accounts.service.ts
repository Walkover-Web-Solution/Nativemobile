...
export class SettingsLinkedAccountsService {
    ...
    public GetEbankToken(): Observable<BaseResponse<IGetEbankTokenResponse, string>> {
        ...
        return this._http.get(this.config.apiUrl + EBANKS.GET_TOKEN.replace(':companyUniqueName', this.companyUniqueName)).pipe(map((res) => {
            const data: BaseResponse<IGetEbankTokenResponse, string> = res;
            return data;
    ...
    public GetAllEbankAccounts(): Observable<BaseResponse<IGetAllEbankAccountResponse[], string>> {
        ...
        return this._http.get(this.config.apiUrl + EBANKS.GET_ALL_ACCOUNTS.replace(':companyUniqueName', this.companyUniqueName)).pipe(map((res) => {
            const data: BaseResponse<IGetAllEbankAccountResponse[], string> = res;
            return data;
    ...
    public DeleteBankAccount(loginId: string): Observable<BaseResponse<any, string>> {
        this.user = this._generalService.user;
        this.companyUniqueName = this._generalService.companyUniqueName;
        return this._http.delete(this.config.apiUrl + EBANKS.DELETE_BANK_ACCOUNT.replace(':companyUniqueName', this.companyUniqueName).replace(':loginId', loginId)).pipe(map((res) => {
            const data: BaseResponse<any, string> = res;
    ...
    public RefreshBankAccount(loginId: string): Observable<BaseResponse<any, string>> {
        this.user = this._generalService.user;
        this.companyUniqueName = this._generalService.companyUniqueName;
        return this._http.get(this.config.apiUrl + EBANKS.REFREST_ACCOUNT.replace(':companyUniqueName', this.companyUniqueName).replace(':loginId', loginId)).pipe(map((res) => {
            const data: BaseResponse<any, string> = res;
            data.queryString = {loginId};
            return data;
        }), catchError((e) => this.errorHandler.HandleCatch<any, string>(e)));
    ...
    public UnlinkBankAccount(accountId: string): Observable<BaseResponse<any, string>> {
        this.user = this._generalService.user;
        this.companyUniqueName = this._generalService.companyUniqueName;
        return this._http.delete(this.config.apiUrl + EBANKS.UNLINK_ACCOUNT.replace(':companyUniqueName', this.companyUniqueName).replace(':accountId', accountId)).pipe(map((res) => {
            const data: BaseResponse<any, string> = res;
            data.queryString = {accountId};
            return data;
        }), catchError((e) => this.errorHandler.HandleCatch<any, string>(e)));
